...
export class VP8LTransform {
  ...
  private static readonly predictors = [
    this.predictor0.bind(this),
    this.predictor1.bind(this),
    this.predictor2.bind(this),
    this.predictor3.bind(this),
    this.predictor4.bind(this),
    this.predictor5.bind(this),
    this.predictor6.bind(this),
    this.predictor7.bind(this),
    this.predictor8.bind(this),
    this.predictor9.bind(this),
    this.predictor10.bind(this),
    this.predictor11.bind(this),
    this.predictor12.bind(this),
    this.predictor13.bind(this),
    this.predictor0.bind(this),
    this.predictor0.bind(this),
  ];
}
