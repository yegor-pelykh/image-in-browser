...
/**
 * Class representing an 8-bit palette.
 */
export class PaletteInt8 implements Palette {
   ...
   * @returns {Int8Array} The internal data array.
   */
  ...
  /**
   * Creates a new PaletteInt8 instance from another instance.
   * @param {PaletteInt8} other - The other PaletteInt8 instance.
   * @returns {PaletteInt8} A new PaletteInt8 instance.
   */
  public static from(other: PaletteInt8): PaletteInt8 {
  ...
  /**
   * Creates a clone of the current PaletteInt8 instance.
   * @returns {PaletteInt8} A new PaletteInt8 instance.
   */
  ...
  /**
   * Converts the internal data array to a Uint8Array.
