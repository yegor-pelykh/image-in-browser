...
/**
 * Class representing a palette with 32-bit floating point colors.
 */
export class PaletteFloat32 implements Palette {
  ...
  /**
   * Gets the color data.
   * @returns {Float32Array} The color data.
   */
  ...
  /**
   * Creates an instance of PaletteFloat32.
  ...
  /**
   * Creates a new PaletteFloat32 from an existing one.
   * @param {PaletteFloat32} other - The existing palette.
   * @returns {PaletteFloat32} The new palette.
   */
  public static from(other: PaletteFloat32): PaletteFloat32 {
   ...
   * @returns {PaletteFloat32} The cloned palette.
   */
