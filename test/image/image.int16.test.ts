...
describe('MemoryImage', () => {
  /**
   * Test case for creating and manipulating int16 format images with different numbers of channels.
   */
  test('int16', () => {
    // Test for single channel image
    ...
    expect(i1.format).toBe(Format.int16);
