...
/**
 * MemoryImage — uint4 pixel format tests.
 */
describe('MemoryImage', () => {
  /**
   * A 32x32 image with uint4 format and 1 channel.
   */
  test('uint4 nc:1', () => {
  ...
  /**
   * A 32x32 image with uint4 format and 2 channels.
   */
  test('uint4 nc:2', () => {
  ...
  /**
   * A 32x32 image with uint4 format and 3 channels.
   */
  test('uint4 nc:3', () => {
  ...
  /**
   * A 32x32 image with uint4 format and 4 channels.
   */
  test('uint4 nc:4', () => {
  ...
  /**
   * A 32x32 image with uint4 format, 3 channels, and a palette.
   */
  ...
  /**
   * A 32x32 image with uint4 format, 4 channels, and a palette.
   */
